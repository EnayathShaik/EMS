        ...
        <div class="row login-form-position">
            ...
            <div class="col-md-4 col-sm-4 col-xs-12" data-aos="zoom-in">
				...
				<c:if test="${not empty param['error']}">
					<strong class="text-transform: uppercase;"><c:out
							value="${SPRING_SECURITY_LAST_EXCEPTION.message}" /></strong>
				</c:if>

				<form class="form-background" action="${loginUrl}" method="post" name="loginform">
                
                    <div class="form-group">
                        <label><i class="fa fa-user"></i> User ID</label>
                        <input type="text" name='username' class="form-control" placeholder="Enter your User ID" required>
                    </div>
                    ...
                    <div class="form-group">
						...
						<button type="submit" id="billerloginID" style="width: 100%" class="btn btn-success">Login</button>
