									...
									<ul class="nav nav-tabs">
										...
										<div class="col-md-12">
											...
											<div class="form-group col-md-6">
              								<label> <i class=" fa fa-user"></i>  Reporting To <span class="aestrik">*</span> </label>
              								<input type="text" class="form-control"  placeholder="Reporting To.." id="reportingnameID"/>
           								   </div>
            
								            <div class="form-group col-md-6">
								              <label><i class="fa fa-key" aria-hidden="true"></i> Designation <span class="aestrik">*</span> </label>
								              <input type="text" class="form-control" id="designationID" placeholder="Designation.."/>
								            </div>
								            
								             <div class="form-group col-md-6">
              								<label>Total Gross salary per month <span class="aestrik">*</span> </label>
              								<input type="text" class="form-control"  placeholder="Total Gross salary per month.." id="salaryID"/>
           								   </div>
