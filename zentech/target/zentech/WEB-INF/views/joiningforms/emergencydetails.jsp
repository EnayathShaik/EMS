						...
						<div class="forum-list">
								...
								<div class="forum-list">
									<ul class="nav nav-tabs">
										...
										<form:form action="./emergency-records" method="Post"  commandName="emergencyRecords"
										       id="emergencyFormID" name="emergencyFormName">
											<div class="form-group col-md-6">
              								<label>  Blood Group <span class="aestrik">*</span> </label>
              								<form:input type="text" class="form-control" path="bloodGroup"  placeholder="Enter Blood Group" id="bloodGroupID"/>
           								   </div>
            
								            <div class="form-group col-md-6">
								              <label> Allergic To <span class="aestrik">*</span> </label>
								              <form:input type="text" class="form-control" path="allergicTo" id="allergicID" placeholder="Allergic To.."/>
								            </div>
								            
								             <div class="form-group col-md-12">
              								<label> Blood Pressure <span class="aestrik">*</span> </label>
              								<form:input type="text" class="form-control"  path="bloodPressure"  placeholder="Blood Pressure.." id="bloodPressureID"/>
			           								   </div>
			
			
											<div class="form-group col-md-12">
												<label> Eye Sight <span class="aestrik">*</span>
												</label> <form:input type="text" class="form-control" path="eyeSightLeft" placeholder="Left"
													id="lefteyeID" /> <form:input type="text" class="form-control" path="eyeSightRight"
													placeholder="Right" id="righteyeID" />
			
											</div>
			
			
											<div class="form-group col-md-12">
								              <label> Any Major Illness <span class="aestrik">*</span> </label>
								              <form:textarea class="form-control" path="anyMajorIllness" id="majorillnessID" rows="2"  maxlength="100" />
								            </div>
											
											<div class="form-group col-md-12">
              								<label> <i class=" fa fa-user"></i> Contact Person in case of Emergency: <span class="aestrik">*</span> </label>
              								<form:input type="text" class="form-control" path="contactPersonInCaseOfEmergency"  placeholder="Emergency Contact.." id="emergencyContactID"/>
           								   </div>
           								   
           								    <div class="form-group col-md-12">
								              <label><i class="fa fa-home" aria-hidden="true"></i> Address <span class="aestrik">*</span> </label>
								              <form:textarea class="form-control" path="emergencyAddress" id="emergencyAddressID" rows="2"  maxlength="100"/>
								            </div>
           								   
           								   <div class="form-group col-md-4">
              								<label> Phone  <span class="aestrik">*</span> </label>
              								<form:input type="text" class="form-control" path="emergencyNumber"  placeholder="Enter Phone" id="WeightID"/>
           								   </div>
